...
# Project: D:\Documents\GBM2100\Projet\Laboratoire3\Comm_SpO2.cydsn\Comm_SpO2.cyprj
# Date: Tue, 20 Apr 2021 18:24:59 GMT
#set_units -time ns
...
create_generated_clock -name {I2C_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 13 27} [list [get_pins {ClockBlock/ff_div_2}]]
create_generated_clock -name {I2Cm_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 13 27} [list [get_pins {ClockBlock/ff_div_3}]]
...
create_generated_clock -name {DEBUG_UART_SCBCLK} -source [get_pins {ClockBlock/periclk}] -edges {1 109 219} [list [get_pins {ClockBlock/ff_div_5}]]
...
# Component constraints for D:\Documents\GBM2100\Projet\Laboratoire3\Comm_SpO2.cydsn\TopDesign\TopDesign.cysch
# Project: D:\Documents\GBM2100\Projet\Laboratoire3\Comm_SpO2.cydsn\Comm_SpO2.cyprj
# Date: Tue, 20 Apr 2021 18:23:58 GMT
