// ======================================================================
// Comm_SpO2.v generated from TopDesign.cysch
// 04/20/2021 at 14:23
...
module CapSense_v3_0_4 ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("a3e1a086-02d5-470e-be85-14b4f9c6f5db/77fd7f86-2082-41fa-a471-914d5f07502d"),
		  .width(4),
		  .sio_grp_cnt(0),
		  .drive_mode("0,0,0,0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a3e1a086-02d5-470e-be85-14b4f9c6f5db/dbc12ae1-a607-4701-99cc-6261716a9147"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a3e1a086-02d5-470e-be85-14b4f9c6f5db/2605f567-73b7-435d-b3b9-174766b96934"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_clock_v1_0
		#(.id("a3e1a086-02d5-470e-be85-14b4f9c6f5db/8273f0d6-caef-4cc7-ad3c-09656b78e2cb"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a3e1a086-02d5-470e-be85-14b4f9c6f5db/8ed50244-d239-4c9b-9207-b8e71ce193dc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
...
module SCB_I2C_PDL_v2_0_5 (
	...
	cy_clock_v1_0
		#(.id("9333e48c-6a9b-4b1f-a7ce-ce5e039672fc/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("127877237.851662"),
		  .is_direct(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("9333e48c-6a9b-4b1f-a7ce-ce5e039672fc/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("9333e48c-6a9b-4b1f-a7ce-ce5e039672fc/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
module top ;
    ...
    SCB_UART_PDL_v2_0_3 DEBUG_UART (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_509),
        .rts_out(Net_508),
	...
	cy_mxs40_gpio_v1_0
		#(.id("bd77d0e5-7096-43fb-83ab-4666af16ea40"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("3"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("a5ff0027-fded-4d4c-afa5-f854c6fb6b0d"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("98df4f64-bef6-469b-8842-6a5dc595b72b"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("0"),
